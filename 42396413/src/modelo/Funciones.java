...
public class Funciones {
	...
	public static int cantidadDeDias(LocalDate diaInicial, LocalDate diaFinal) {
		int iResultado = 0;

		if (diaFinal.isAfter(diaInicial)) {
			LocalDate diaAux = LocalDate.of(diaInicial.getYear(), diaInicial.getMonthValue(),
					diaInicial.getDayOfMonth());

			while (diaFinal.compareTo(diaAux) >= 0) {
				
				iResultado++;
				LocalDate diaAux2 = diaAux.plusDays(1);
				diaAux = diaAux2;
